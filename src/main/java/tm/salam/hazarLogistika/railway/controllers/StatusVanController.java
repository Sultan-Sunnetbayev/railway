...
import tm.salam.hazarLogistika.railway.services.StatusVanService;
...
public class StatusVanController {
    ...
    public ResponseEntity getStatusVanById(final @RequestParam("id")int id){
    ...
    @PostMapping(path = "/load/statusVan/in/excel/file",consumes = {MediaType.MULTIPART_FORM_DATA_VALUE},produces="application/json")
    ...
    public ResponseTransfer removeStatusVanById(final @RequestParam("id")int id){
    ...
    @GetMapping(path = "/get/statusVan/by/shortName",consumes = {MediaType.MULTIPART_FORM_DATA_VALUE},
                                                    produces = "application/json")
    public ResponseEntity getStatusVanByShortName(final @RequestParam("shortName")String shortName){
