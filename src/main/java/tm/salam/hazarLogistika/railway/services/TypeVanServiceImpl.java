...
import tm.salam.hazarLogistika.railway.daos.TypeVanRepository;
...
public class TypeVanServiceImpl implements TypeVanService{
    ...
    @Override
    public List<String>getAllFullNameTypeVan(){

        List<TypeVan>typeVans=typeVanRepository.findAll();
        List<String>fullName=new ArrayList<>();

        for (TypeVan typeVan:typeVans){

            fullName.add(typeVan.getFullName());
        }
