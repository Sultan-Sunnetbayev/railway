...
import tm.salam.railway.daos.StatusVanRepository;
...
import tm.salam.railway.models.StatusVan;
...
public class StatusVanServiceImpl implements StatusVanService{
    ...
    @Autowired
    public StatusVanServiceImpl(StatusVanRepository statusVanRepository, ExcelService excelService) {
    ...
    public ResponseTransfer loadNewStatusVansInExcelFiles(final MultipartFile excelFile){
        ...
        try {
            ...
            return new ResponseTransfer("error with loading excel files",false);
        }
    ...
    public ResponseTransfer editStatusVanById(final StatusVanDTO statusVanDTO){
        ...
        if(statusVanRepository.findStatusVanByCodeAndShortNameAndFullName(statusVanDTO.getCode(),statusVanDTO.getShortName(),
            ...
            return new ResponseTransfer("status van successful edited",false);
        }else{
    ...
    public ResponseTransfer removeStatusVanById(final int id){
        ...
        if(statusVan!=null){
            ...
            return new ResponseTransfer("status not found with this id",false);
        }
    ...
    @Override
    public StatusVanDTO getStatusVanDTOById(int id){
    ...
    @Override
    public StatusVanDTO getStatusVanDTOByShortName(String shortName){
